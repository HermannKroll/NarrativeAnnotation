...
def main():
    ...
    db_w_chembl, chembl = DrugVocabulary.create_drugbank_vocabulary_from_source(expand_term=False, use_chembl_synonyms=True, return_chembl_vocab=True, chembl_file="/home/jan/chembl_synonyms.csv")

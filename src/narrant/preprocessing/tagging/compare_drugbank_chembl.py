...
def main():
    vocab_without_chembl = reverse_set_index(DrugTaggerVocabulary.create_drugbank_vocabulary_from_source(expand_term=False))
    db_w_chembl, chembl = DrugTaggerVocabulary.create_drugbank_vocabulary_from_source(expand_term=False,use_chembl_synonyms=True, return_chembl_vocab=True, chembl_file="/home/jan/chembl_synonyms.csv")

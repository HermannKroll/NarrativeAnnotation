...
```
python3 src/narrant/entitylinking/pharmaceutical_entity_linking.py -i test.json --collection test
```
...
```
python3 src/narrant/entitylinking/pharmaceutical_entity_linking.py -i test.json --collection test --workers 10
```

If you are certain that all documents are already in the database, you may skip the loading phase by:
```
python3 src/narrant/entitylinking/pharmaceutical_entity_linking.py -i test.json --collection test --skip-load
```
...
```
python3 src/narrant/entitylinking/pharmaceutical_entity_linking.py -i test.json --collection test --workdir temp/
```
